...
public class ISO8601DateParser {
    ...
    public static String toString( Date date ) {
        ...
        String output = df.format( date ); // Konverterer...
...
//        String result = s0 + s1;
        ...
        String result = output.replaceAll( "UTC", "Z" );
    ...
    public static void main(String[] args) throws Exception {
    	...
    	System.out.println("UTC: " + toString(now));
    	String utcString = "2004-06-14T19:20:30Z";
    	System.out.println("Raw: " + utcString);
    	System.out.println("Localized: " + parse(utcString));
