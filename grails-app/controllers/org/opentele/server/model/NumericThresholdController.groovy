...
class NumericThresholdController {
	...
	def show() {
		def standardThresholdInstance = NumericThreshold.get(params.id)
	...
	def update() {
        ...
        if(!ThresholdValidationUtil.validateFloatInput(params.alertHigh, standardThresholdInstance, "alertHigh")) {
        ...
        if(!ThresholdValidationUtil.validateFloatInput(params.warningHigh, standardThresholdInstance, "warningHigh")) {
            standardThresholdInstance.errors.reject("default.threshold.edit.error",
                                                    [message(code: "default.threshold.warningHigh.label")] as Object[],
                                                    "i18n missing")
        }
        if (!ThresholdValidationUtil.validateFloatInput(params.warningLow, standardThresholdInstance, "warningLow")) {
            standardThresholdInstance.errors.reject("default.threshold.edit.error",
                                                    [message(code: "default.threshold.warningLow.label")] as Object[],
                                                    "i18n missing")
        }
        if (!ThresholdValidationUtil.validateFloatInput(params.alertLow, standardThresholdInstance, "alertLow")) {
            standardThresholdInstance.errors.reject("default.threshold.edit.error",
