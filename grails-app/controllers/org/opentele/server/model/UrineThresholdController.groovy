...
class UrineThresholdController {
	 ...
	 */
    @Secured(PermissionName.THRESHOLD_READ_ALL)
	def index() {
	...
	def show() {
		def standardThresholdInstance = UrineThreshold.get(params.id)
	...
	def update() {
        ...
        if(!ThresholdValidationUtil.validateProtienInput(params.alertHigh, standardThresholdInstance, "alertHigh")) {
            standardThresholdInstance.errors.reject("default.urineThreshold.edit.error",
                    [message(code: "default.threshold.alertHigh.label")] as Object[],
                    "i18n missing")
        }
        if(!ThresholdValidationUtil.validateProtienInput(params.warningHigh, standardThresholdInstance, "warningHigh")) {
            standardThresholdInstance.errors.reject("default.urineThreshold.edit.error",
                    [message(code: "default.threshold.warningHigh.label")] as Object[],
                    "i18n missing")
        }
        if (!ThresholdValidationUtil.validateProtienInput(params.warningLow, standardThresholdInstance, "warningLow")) {
            standardThresholdInstance.errors.reject("default.urineThreshold.edit.error",
                    [message(code: "default.threshold.warningLow.label")] as Object[],
                    "i18n missing")
        }
        if (!ThresholdValidationUtil.validateProtienInput(params.alertLow, standardThresholdInstance, "alertLow")) {
            standardThresholdInstance.errors.reject("default.urineThreshold.edit.error",
