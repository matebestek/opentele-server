...
<html>
	<head>
		...
		<g:set var="entityName" value="${passiveIntervalInstance?.patient?.name()}" />
		<title><g:message code="passiveInterval.interval.show" args="[entityName]" /></title>
	</head>
	<body>
	
		<div id="show-passiveInterval" class="content scaffold-show" role="main">
			<h1><g:message code="passiveInterval.interval.show" args="[entityName]" /></h1>
			...
			<ol class="property-list passiveInterval">
                ...
                <g:if test="${passiveIntervalInstance?.intervalStartDate}">
                    <li class="fieldcontain">
                        <span id="intervalStartDate-label" class="property-label"><g:message code="passiveInterval.intervalStartDate.label" default="Interval Start Date" /></span>
				...
				<li class="fieldcontain">
					<span id="intervalEndDate-label" class="property-label"><g:message code="passiveInterval.intervalEndDate.label" default="Interval End Date" /></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${passiveIntervalInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
