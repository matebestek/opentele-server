<%@ page import="org.opentele.server.model.types.GlucoseInUrineValue; org.opentele.server.model.types.ProteinValue; org.opentele.server.model.types.MeasurementTypeName" %>
<!doctype html>
<html>
<head>
