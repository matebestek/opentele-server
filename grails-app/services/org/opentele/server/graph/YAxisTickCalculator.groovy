package org.opentele.server.graph

import org.opentele.server.TickY
import org.opentele.server.model.types.MeasurementTypeName
import org.opentele.server.model.types.MeasurementTypeNameVisitor

import java.text.NumberFormat

class YAxisTickCalculator implements MeasurementTypeNameVisitor {
    private static ThreadLocal<NumberFormat> INTEGER_FORMATTER = new ThreadLocal<>() {
        @Override
    ...
    private static ThreadLocal<NumberFormat> SINGLE_DIGIT_FORMATTER = new ThreadLocal<>() {
        @Override
        protected NumberFormat initialValue() {
    ...
    void visitBloodSugar() {
        ...
        maximum += tickSize
        createTicksFor(minimum, maximum, tickSize, SINGLE_DIGIT_FORMATTER)
    }
